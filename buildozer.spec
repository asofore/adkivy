...
requirements = python3,kivy,pyjnius,kivmob,plyer
...
presplash.filename = fi.png

# (str) Icon of the application
icon.filename = fi.png
...
android.permissions =INTERNET ,ACCESS_NETWORK_STATE,VIBRATE,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE
...
android.activity_class_name = com.test.simple.MainActivity
